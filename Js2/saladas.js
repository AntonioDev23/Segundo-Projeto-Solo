export const receitasSaladas = {  
  saladaFrutas: {
    ...
    preparo: [
      ...
      'Misture delicadamente e decore com folhas de hortelã.',
      'Sirva gelado.'
    ]
  },
  ...
  saladaCaesar: {
    ...
    preparo: [
      ...
      'Misture a alface com os croutons.',
      'Adicione o molho Caesar e o queijo parmesão.',
      'Misture bem e sirva.'
    ]
  },
  ...
  saladaGrega: {
    ...
    ingredientes: [
      ...
      'Orégano, azeite e suco de limão a gosto'
    ],
    preparo: [
      'Misture todos os ingredientes em uma tigela.',
      'Tempere com orégano, azeite e suco de limão.',
      'Sirva fresca.'
    ]
  },
  ...
  saladaCaprese: {
    ...
    preparo: [
      'Alterne fatias de tomate e mussarela em um prato.',
  ...
  saladaRussa: {
    ...
    preparo: [
      'Misture todos os legumes e a maçã em uma tigela.',
  ...
  saladaCenouraBeterraba: {
    ...
    preparo: [
      'Misture a cenoura e a beterraba raladas.',
      'Tempere com suco de limão, azeite, sal e pimenta.',
      'Sirva fresca.'
    ]
  },
...
// Detalhes da receita
function criarModalDetalhesSaladas(salada) {
  ...
  // Título centralizado
  const titulo = document.createElement('h2');
  titulo.textContent = salada.titulo;
  ...
  salada.ingredientes.forEach(item => {
